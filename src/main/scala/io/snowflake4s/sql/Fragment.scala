...
final case class Fragment(sql: String, params: Vector[Param]) {
   ...
   * @return a new combined fragment
   */
   ...
   * @return a new fragment with the string appended
   */
   ...
   *
   * @param sqlPart the string to prepend
   * @return a new fragment with the string prepended
   */
   ...
   *
   * @param marginChar the margin character to strip
   * @return a new fragment with margin stripped
   */
   ...
   *
   * @return true if both SQL and params are empty
   */
...
object Fragment {
   ...
   * @param put the encoder for the value type
